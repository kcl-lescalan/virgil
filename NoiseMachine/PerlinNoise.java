...
* Modified by Luis Escalante 
*/

package NoiseMachine;

/*
* Modified to set seed in constructor
*/
public final class PerlinNoise {
    ...
    //------START OF RETURNABLES--------//
    public static double noise(double x) {

       int bx0, bx1;
       double rx0, rx1, sx, t, u, v, res;
       t = x + N;
       bx0 = ((int)t)&M;
       bx1 = (bx0+1)&M;
       rx0 = t - (int) t;
    ...
    protected static int getSeed(){return PerlinNoise.seed;}
    //-------END OF RETURNABLES-------//
    
    protected static void setSeed(int s){PerlinNoise.seed = s;}
